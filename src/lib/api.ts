...
export async function adjustPlay(songId: string, delta: number): Promise<{ song: Catalog['songs'][number] }> { return request(`/api/admin/songs/${songId}/plays`, { method: 'POST', body: JSON.stringify({ delta }) }); }
